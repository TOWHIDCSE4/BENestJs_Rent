...
export class RegistrationDto {
  ...
  @ApiProperty({ description: 'gửi tin nhắn (DV SAHA gửi tới 8085)', required: false })
  @IsOptional()
  @IsString()
  otp: string;

  @ApiProperty({ description: 'phone(từ sdt) email(từ email) mặc định là phone', required: false})
  @IsOptional()
  @IsString()
  otp_from: string;
}
